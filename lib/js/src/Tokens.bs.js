...
function parseDirectHighlightings(tokens) {
  return Belt_Array.keepMap(Belt_Array.map(Js_array.sliceFrom(2, tokens), parse), (function (x) {
                return x;
              }));
}
...
function lookupLocalSrcLoc(self, offset) {
  return AVLTree$AgdaModeVscode.lowerBound(self.tokens, offset);
}
...
var Module = {
  ...
  lookupLocalSrcLoc: lookupLocalSrcLoc,
...
exports.lookupLocalSrcLoc = lookupLocalSrcLoc;
